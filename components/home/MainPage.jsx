  ...
  return (
    <div className=" h-full w-full max-w-[1400px] mx-auto">
      ...
      <div className="  md:mt-4 mt-3 lg:mt-6  mx-auto">
        <div className=" flex items-center justify-between border-l-4 border-[#f4c720] px-2 py-2">
          <div>
          ...
          <div className="px-2.5 py-1.5 flex w-[150px] items-center gap-2 text-gray-text rounded-full bg-gray-bg border border-border-color">
      ...
      <Creator />
      <div className=" fixed right-8 bottom-26">
