...
export default function RegisterForm() {
  ...
  useEffect(() => {
    ...
    const allState = State.getStatesOfCountry(selectedCountry);
  ...
  useEffect(() => {
    ...
    const isoCode = selectedState.split("-")[0];
    console.log(countryCode, isoCode);
  ...
  return (
    <div className="min-h-screen md:py-8 py-4 lg:py-12 text-white font-poppins flex items-center justify-center px-2 lg:px-4">
      <div className="w-full max-w-xl  ">
        ...
        {/* Form */}
        <form className=" md:space-y-3 space-y-2 lg:space-y-5 bg-[#0d0d0d] border border-[#ffffff12] p-8 rounded-lg">
          {/* Full Name */}
          <div>
        ...
        <p className="text-center text-sm text-gray-400 mt-3">
          ...
          <Link href={'/login'} className="text-yellow-400 cursor-pointer">Log In</Link>
        </p>
      </div>
    </div>
  );
